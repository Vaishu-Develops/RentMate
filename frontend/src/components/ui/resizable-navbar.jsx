...
export const MobileNavToggle = ({ isOpen, onClick }) => {
  return isOpen ? (
    <IconX className="h-6 w-6 text-black dark:text-white cursor-pointer" onClick={onClick} />
  ) : (
    <IconMenu2 className="h-6 w-6 text-black dark:text-white cursor-pointer" onClick={onClick} />
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    secondary: "bg-transparent border border-gray-300 text-gray-700 hover:bg-gray-50 dark:text-white dark:border-gray-600 dark:hover:bg-gray-800",
